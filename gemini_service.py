...
def analyze_budget(api_key: str, model: str, budget: ExtractedBudget, metrics: FinancialMetrics) -> str:
    ...
    prompt = (
        ...
        " You MUST Provide users with a financial health score based on the analysis, make this score out of 100 and provide users 3 reasons why they were given the score they were given"
        "the scoring criteria is as follows (print this for users to know as well): 0-20 very dire, fix finances immediately, 20-40 barely above water, 40-60 doing fine but could fail very quickly, 60-80 generally doing well, but some weaknesses here and there, 80-100 - exceptionally well, very few gaps"
        """
